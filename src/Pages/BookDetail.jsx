...
const BookDetail = () => {
  ...
  return (
    <div className="bg-[#e1c6ab] w-full text px-4 sm:px-6 lg:px-8 py-6 ">
    <div className="max-w-4xl mx-auto">
      ...
      {/* Author */}
      <h2 className="text-center text-lg sm:text-xl md:text-2xl mt-2 text-gray-700">
        {book.author}
      </h2>
    </div>
    ...
    <div className="py-4">
      <div
        ...
        className="text-sm sm:text-base md:text-lg leading-relaxed max-w-3xl mx-auto text-gray-800"
      ></div>
    </div>
  </div>
